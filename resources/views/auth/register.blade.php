                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" style="display: flex;flex-direction:column;">
                        ...
                        <div class="row mb-3" style="width: 80%;display: flex;margin: auto;">
                            <div class="col-md-6" style="width: 100%;display: flex;border:2px solid black; padding: 3px;border-radius:8px;">
                                <div style="width:30px;height:30px;margin:auto; border-radius: 20px; display: flex;">
                                    <img src="{{ asset('assets/auth/UsernameLogo.png') }}" style="width: 25px; height: 25px; display: flex; justify-content: center; align-items: center; margin: auto;">
                                </div>
                        ...
                        <div class="row mb-3" style="width: 80%;display: flex;margin:auto;">
                            <div class="col-md-6" style="width: 100%;display: flex;border:2px solid black; padding: 3px;border-radius:8px;">
                                <div style="width:30px;height:30px;margin:auto; border-radius: 20px; display: flex;">
                                    <img src="{{ asset('assets/auth/PasswordLogo.png') }}" style="width: 25px; height: 25px; display: flex; justify-content: center; align-items: center; margin: auto;">
                                </div>
                        ...
                        <div class="row mb-3" style="width: 80%;display: flex;margin:auto;">
                            <div class="col-md-6" style="width: 100%;display: flex;border:2px solid black; padding: 3px;border-radius:8px;">
                                <div style="width:30px;height:30px;margin:auto; border-radius: 20px; display: flex;">
                                    <img src="{{ asset('assets/auth/ConfirmPasswordLogo.png') }}" style="width: 25px; height: 25px; display: flex; justify-content: center; align-items: center; margin: auto;">
                                </div>
