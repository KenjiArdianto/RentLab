...
class AdminUserSuspendSelectedRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'selected.required' => 'You must select at least one user to suspend.',
            'selected.array' => 'The selected users must be in array format.',
            'selected.min' => 'You must select at least one user.',
